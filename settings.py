...
ROOMS = [
    ...
    # {
    #     'name': 'group1',
    #     'display_name': '计科&软件（实验）',
    #     'participant_label_file': '_rooms/计科&软件.txt',
    # },
    # {
    #     'name': 'group2',
    #     'display_name': '网络&信工（对照）',
    #     'participant_label_file': '_rooms/网络&信工.txt',
    # },
]
